					...
					<div class="card-body">
						...
						<table class="table table-bordered table-condensed table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$faculty =  $conn->query("SELECT *,concat(faculty_id) as name from faculty order by concat(faculty_id) ");
								...
								<tr>
									...
									<td class="text-center">
										...
										<button class="btn btn-sm btn-outline-primary edit_faculty" type="button" data-id="<?php echo $row['idFC'] ?>" >Edit</button>
										<button class="btn btn-sm btn-outline-danger delete_faculty" type="button" data-id="<?php echo $row['idFC'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
