...
<div class="modal-footer display">
	<div class="row">
		<div class="col-md-12">
			...
			<button class="btn float-right btn-danger mr-2 confirmation" type="button" data-id="<?php echo $id ?>" >Reject</button>
...
<script>
    ...
    $('.confirmation').click(function(){
		uni_modal("Booking Reject","reject_booking.php?id="+$(this).attr('data-id'),'large')
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					...
					<?php
					$id=$_GET['id'];
					$qry = $conn->query("UPDATE schedules SET status = 'Approved' where id='$id'");
					?>
					setTimeout(function(){
						window.location.href="http://localhost/eventroom/scheduling/admin/index.php?page=viewcalendar";
					},1500)
				}
                else {
